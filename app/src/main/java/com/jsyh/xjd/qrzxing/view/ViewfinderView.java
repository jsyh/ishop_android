...
package com.jsyh.xjd.qrzxing.view;
 ...
 * transparency outside it, as well as the laser scanner animation and aliPayResponse points.
 * �Զ����View������ʱ�м���ʾ��
 */
...
//    textPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
  ...
  public void onDraw(Canvas canvas) {
    ...
    if (resultBitmap != null) {
      // Draw the opaque aliPayResponse bitmap over the scanning rectangle
...
//      canvas.drawText(text,middle - 112,frame.bottom + 60,textPaint);
  ...
  /**
   * Draw a bitmap with the aliPayResponse points highlighted instead of the live scanning display.
   *
