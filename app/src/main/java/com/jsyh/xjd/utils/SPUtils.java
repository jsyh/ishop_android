...
public class SPUtils {
    ...
    public static ArrayList<String> getHistory(Context context) {
        try {
            ...
            historyList = (ArrayList<String>) ObjectSerializer.deserialize(o);
            return historyList;
        } catch (IOException e) {
            return null;
        }
     ...
     * @param searchKey
     */
    public static void addToHistory(Context context,String searchKey) {
        //mClearEditText.setText(searchKey);
        ArrayList<String> historyList = getHistory(context);
        ...
        try {
            ...
            SPUtils.put(context, SPConfig.SEARCH_HISTORY_KEY, ObjectSerializer.serialize(historyList));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
