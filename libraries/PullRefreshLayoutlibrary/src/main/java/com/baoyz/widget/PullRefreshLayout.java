...
public class PullRefreshLayout extends ViewGroup {
    ...
    public static final int STYLE_Bitmap = 4;
    ...
    public void setRefreshStyle(int type){
        ...
        switch (type){
            ...
            case STYLE_RING:
                ...
                break;
            case STYLE_Bitmap:
                mRefreshDrawable = new BitmapDrawable(getContext(), this);
                break;
            default:
...
//        mRefreshView.layout(width / 2 - mRefreshViewWidth / 2, -mRefreshViewHeight + mCurrentOffsetTop, width / 2 + mRefreshViewHeight / 2, mCurrentOffsetTop);
        ...
        if (mListener != null && mCurrentOffsetTop > 0) {
            mListener.onMove(true);
        }else if(mListener != null && mCurrentOffsetTop == 0){
            mListener.onMove(false);
        }
